...
import { ArrowLeft, Shield, Save, Loader2, Send, CalendarIcon, Pencil, X, Wrench, Plus, Trash2, Package, Factory, Truck, QrCode, Building2, CreditCard, UserPlus } from "lucide-react";
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const basePayload = {
        ...
        idTipoPedido: 1,
        observacoes: nomusFields.observacoes || currentDefect || `Pedido de Garantia - ${nomusFields.cliente}`,
        observacoesInternas: "",
        itensPedido,
